...
public class DeepCopy {
    ...
    public static void main(String[] args) {
        ...
        HashSet<Person> test = deepCopy(set);

        Person mohan = null;
        for(Person p : test) {
            if(p.getName().equals("Mohan")) {
                mohan = p;
                break;
            }
        }
        if(mohan != null) {
            mohan.setName("New name");
            System.out.println("Old object's name: " + p2.getName());
        }
